package az.ingress.book_user_store.config.producer;
...
public class KafkaProducer {
    ...
    public void send(String topic, BookDTO data) {
        ...
        ListenableFuture<SendResult<String, BookDTO>> listenableFuture =
                (ListenableFuture<SendResult<String, BookDTO>>) kafkaTemplate.send(bookDTOMessage);
