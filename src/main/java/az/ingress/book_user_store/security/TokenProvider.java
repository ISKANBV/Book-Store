...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        Optional<az.ingress.book_user_store.domain.User> optionalUser = userRepository.findByUsername(claims.getSubject());

        if (optionalUser.isEmpty()) {
            return null;
        }

        az.ingress.book_user_store.domain.User user = optionalUser.get();
